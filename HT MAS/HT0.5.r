...
Resul<-data.frame(rho=0.5,Estim="HT-MAS",n.muestra=paste0("n= ",n), Medida.Calidad(dat.HT,ty))


n = 400 
dat.HT <- t(replicate(1000,HT(y,n)))
Resul<- data.frame(rbind(
  data.frame(rho=0.5,Estim="HT-MAS",n.muestra=paste0("n= ",n), Medida.Calidad(dat.HT,ty)),Resul))
